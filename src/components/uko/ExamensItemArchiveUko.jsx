...
const ExamensItemArchiveUko = ({ examen }) => {
  let dateExamen = ''
      ...
      <div className="examens-item__btns">
        {
          ...
          : <Link to={`/uko/examen-statistic/${examen.examenId}`} className='discipline-btn'>{examen.discipline}</Link>
        }
      </div>
    </li>
  )
...
export default ExamensItemArchiveUko