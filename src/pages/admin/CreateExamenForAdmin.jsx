...
import CreateExamenForm from '../../components/common/CreateExamenForm'

const CreateExamenForAdmin = () => { 
        ...
        <section className='create-examen'>
            <div className="container container--smaller">
                <div className="create-examen__inner">
                    ...
                    <CreateExamenForm onSubmit={onSubmit} />
                </div>
            </div>
        </section>
    )
...
export default CreateExamenForAdmin