      ...
      <div className="container container--smaller">
        <div className="create-tickets__inner">
          ...
          <h1 className='create-tickets__title title'>Редактирование билетов</h1>
          {
            ...
            :
            <EditTicketsForm ticketsData={tickets} backLink="/admin" onSubmit={editExamen} isLoading={isExamenLoading} />
          }
        </div>
      </div>
    </section>
...
export default EditTicketsForAdmin